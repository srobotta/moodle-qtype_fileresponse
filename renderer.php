...
class qtype_fileresponse_renderer extends qtype_renderer {
    ...
    public function files_input(question_attempt $qa, $numallowed,
        ...
        if ($forcedownload) { /* don't download fix */
            ...
            $filesrenderer = $this->page->get_renderer('qtype_fileresponse', 'fileresponsesimplifiedfilemanager');
            ...
            $filesrenderer = $this->page->get_renderer('qtype_fileresponse', 'fileresponsefilemanager');
