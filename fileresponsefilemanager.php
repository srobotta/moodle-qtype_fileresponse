...
class MoodleQuickForm_fileresponsefilemanager extends HTML_QuickForm_element {
     ...
     */
    function MoodleQuickForm_fileresponsefilemanager($elementName=null, $elementLabel=null, $attributes=null, $options=null) {
        global $CFG, $PAGE;
        require_once("$CFG->dirroot/repository/lib.php");
...
class qtype_fileresponse_fileresponsefilemanager_renderer extends plugin_renderer_base {
     ...
     * 'fm-nofiles' - when fileresponsefilemanager has no files at all (although there might be folders);
